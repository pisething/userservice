...
public class AuthServiceImpl implements AuthService {
    ...
    public Mono<LoginResponse> login(LoginRequest request) {
        /*
         * Reason:
         * AuthServiceImpl is now a thin service layer.
         * It delegates the login workflow to LoginFacade.
         */
    ...
    public Mono<Void> requestForgotPinOtp(ForgotPinRequest request) {
        /*
         * Reason:
         * Forgot PIN OTP workflow belongs to RequestForgotPinOtpFacade.
         */
    ...
    public Mono<UserAccountResponse> resetPin(ResetPinRequest request) {
        /*
         * Reason:
         * Reset PIN is a multi-step workflow.
         * The Facade coordinates those steps.
         */
